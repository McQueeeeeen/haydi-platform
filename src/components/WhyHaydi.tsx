...
const points: TrustCard[] = [
  ...
  },
  {
    ...
    description: 'Более 20 сертифицированных фабрик в каталоге, включая Maytoni, Lightstar, Eglo и ODEON LIGHT. Все приборы поставляются с официальной гарантией, надлежащей изоляцией цепей и заводскими блоками питания.',
    stat: '02'
  },
  {
